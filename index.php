...
<body>
    ...
    <nav class="navbar navbar-dark navbar-expand-lg navbar-togglable fixed-top">
        <div class="container">
            ...
            <!-- Navbar brand (mobile) -->
            <a class="navbar-brand d-lg-none" href="#">Coffee Aquarius</a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="./menu.html">Localização</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="./reservation.html">Cardápio</a>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link " href="./news-and-events.html">Noticia & Eventos</a>
                    </li>
                    <li class="nav-item">
    ...
    <!-- WELCOME -->
    <header data-jarallax data-speed=".8" style="background-image: url(img/1191493.jpg);">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8 col-lg-6 text-center">
                        ...
                        <h6 class="text-xs text-white-75">
                            <span class="text-primary">Café</span> / Restaurante
                        </h6>
                        ...
                        <p class="text-center text-white-75 mb-7">
                            Localizada no Aquarius em São José dos Campos-SP. Café e biscoitos sempre fresquinhos.
                            Aberto para refeições internas e pedidos para viagem.
                        </p>

                        <!-- Button -->
                        <a class="btn btn-outline-primary text-white text-primary-hover mb-7 mb-md-0" href="cardapio.php">
                            Faça um Pedido
                        </a>
                ...
                <div class="row">
                    ...
                    <div class="col-md">
                        ...
                        <p class="font-serif text-white-75 text-center text-md-end text-lg-end my-md-5">
                            <i class="fas fa-map-marker-alt text-primary me-3"></i> 1234 Dining Str., São José dos
                            Campos, SP 12345-0000
                        </p>
    ...
    <section id="sobre" class="pt-7 pt-md-9">
        <div class="container">
            <div class="row">
                <div class="col-md-2">
                    ...
                    <p class="fs-lg lh-lg text-black mb-5 mb-md-0">
                        Faça uma pausa para o café ou durante uma refeição
                    </p>
                ...
                <div class="col-md-4">
                    ...
                    <div class="media-decoration media-decoration-1 mb-5 mb-md-0">
                        ...
                        <!-- Border -->
                        <div class="media-decoration-border" data-jarallax-element="-50"></div>

                        <!-- Image -->
                        <img class="media-decoration-img img-fluid" src="img/2.jpg" alt="...">
    ...
    <section class="py-7 py-md-9">
            ...
            <div class="row">
                ...
                <div class="col-md-4 order-md-3">
                    ...
                    <div class="media-decoration media-decoration-1 mb-5 mb-md-0">
                        ...
                        <!-- Border -->
                        <div class="media-decoration-border" data-jarallax-element="-20"></div>

                        <!-- Image -->
                        <img class="media-decoration-img img-fluid" src="img/double-espresso-coffee-mug-with-cinnamon-sticks-and-coffee-beans-on-a-wooden-board.jpg" alt="...">
        ...
        <section data-jarallax data-speed=".8" style="background-image: url(img/cafe.jpg);">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-4">
                            ...
                            <p class="fs-lg lh-lg text-black mb-0">
                                Lorem ipsum specialty coffees and award winning doughnuts in a friendly atmosphere.
                            </p>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="d-flex align-items-center">
                            <hr class="hr-sm me-3" style="height: 1px;" /> &copy; 2021 Diego Rodrigues. Todos os direitos reservado.
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p id="cont">Lista de Produtos</p>
                    </div>
                    <div class="modal-footer">
                        <h4>Total:<p class="valor-total"></p>
                        </h4>
                        <button type="button" onclick="limpar()" class="btn btn-warning p-2">Limpar Carrinho</button>
                        <button type="button" class="btn btn-secondary p-2" data-bs-dismiss="modal">+</button>
                        <button type="button" class="btn btn-primary p-2">Comprar</button>
                    </div>
                </div>
            </div>
        </div>
