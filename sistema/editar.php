...
if (isset($_GET['id'])) {
    ...
    if (isset($_GET['btnAtualizar'])) {
        ...
        SET p.nome = '$nome', p.desc = '$desc', p.valor = '$valor' , p.catID = '$catID' WHERE p.produtoID = '$id';";
                    ...
                    <div class="row">
                        <form class="row g-2" method="GET" enctype="multipart/form-data">
                            ...
                            <div class="">
                                ...
                                <textarea name="desc" value="<?php echo $i['desc'] ?>" class="form-control border border-dark" placeholder="Observação..."></textarea>
                            </div>
                            <div class="">
